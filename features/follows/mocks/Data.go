...
func (_m *Data) FollowUser(data follows.Core) error {
	ret := _m.Called(data)
...
func (_m *Data) GetFollowersUsers(followingUserId int) ([]users.Core, error) {
...
func (_m *Data) GetFollowingUsers(followersUserId int) ([]users.Core, error) {
...
func (_m *Data) UnfollowUser(data follows.Core) error {
	ret := _m.Called(data)

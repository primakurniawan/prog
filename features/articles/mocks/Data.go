...
func (_m *Data) CreateArticle(data articles.ArticleCore) error {
	ret := _m.Called(data)
...
func (_m *Data) CreateTags(tags []articles.TagCore) ([]articles.TagCore, error) {
	ret := _m.Called(tags)
...
func (_m *Data) GetAllArticles() ([]articles.ArticleCore, error) {
	ret := _m.Called()
...
func (_m *Data) GetAllUserArticles(userId int) ([]articles.ArticleCore, error) {
...
func (_m *Data) GetArticleById(articleId int) (articles.ArticleCore, error) {
	ret := _m.Called(articleId)
...
func (_m *Data) UpdateArticleById(articleId int, data articles.ArticleCore) error {

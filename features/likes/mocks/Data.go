...
func (_m *Data) GetLikedArticles(userId int) ([]articles.ArticleCore, error) {
...
func (_m *Data) GetLikingUsers(articleId int) ([]users.Core, error) {
...
func (_m *Data) LikeArticle(articleId int, userId int) error {
...
func (_m *Data) UnlikeArticle(articleId int, userId int) error {
	ret := _m.Called(articleId, userId)
